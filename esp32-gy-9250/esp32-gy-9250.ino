...
/*
    Serial.print("gx = "); Serial.print( gx*pi/180.0f, 2); 
    Serial.print(" gy = "); Serial.print( -gy*pi/180.0f, 2); 
    Serial.print(" gz = "); Serial.print( -gz*pi/180.0f, 2); Serial.print(" d/s - ");
 ...
 //   pitch *= 180.0f / PI;
 //   yaw   *= 180.0f / PI; 
 //   yaw   += 0.85f; // Declination at Danville, California is 13 degrees 48 minutes and 47 seconds on 2014-04-04
